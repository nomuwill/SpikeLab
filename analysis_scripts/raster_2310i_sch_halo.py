"""
2310i KOLF2.1J MO — SCH23390 + Halo treatment progression — first 5 min.
UUID: 2026-04-18-e-KOLF21J_MO_control_sch_halo_dopamine_04272026
Output: ~/Desktop/Greg/Organized Recording Raster Plots/2310i_sch_halo_progression.png
"""
...
RECORDINGS = [
    ("D40 — SCH23390 + Halo",           "2310i_KOLF21J_MO_D40_24hr_control_newconfig_04232026",        "04/23/2026"),
    ("D41 — SCH+Halo 24hr post (Con.)", "2310i_KOLF21J_MO_D41_sch_halo_24hr_connectedconfig_04242026", "04/24/2026"),
    ("D41 — SCH+Halo 24hr post (New)",  "2310i_KOLF21J_MO_D41_sch_halo_24hr_newconfig_04242026",       "04/24/2026"),
]
...
fig.suptitle(
    "MEA 2310i  —  KOLF2.1J MO  —  SCH23390 + Halo Progression  —  First 5 min  —  100 ms burst detection",
    fontsize=13, fontweight="bold", y=1.02,
)

save_path = os.path.join(OUT_DIR, "2310i_sch_halo_progression.png")
