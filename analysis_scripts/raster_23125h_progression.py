"""
23125h H9SynGFP MO progression — first 10 min per recording.
No baseline recording exists on S3; progression starts from acute treatment.
UUID: 2026-02-25-e-H9SynGFP_MO_Baseline_haloperidol_dopamine_SCH
Output: ~/Desktop/Greg/Organized Recording Raster Plots/23125h_progression_10min.png
"""
...
# (label, stem, source)
RECORDINGS = [
    ("D34 — Dopamine + Haloperidol acute (02/24/2026)",
     "23125h_MO_H9SynGFP_D34_Dopamine_haloperidol_02242026",                  "phy"),
    ("D35 — Dopamine + Haloperidol 24hr post (02/25/2026)",
     "23125h_MO_H9SynGFP_D35_Dopamine_haloperidol_24hr_02252026",             "pkl"),
    ("D35 — Dopamine + Haloperidol 24hr post (Connected) (02/25/2026)",
...
fig.suptitle(
    "MEA 23125h  —  H9SynGFP MO  —  Dopamine + Haloperidol Progression  —  First 10 min\n"
    "Note: no baseline recording exists on S3 for this MEA",
    fontsize=12, fontweight="bold", y=1.01,
)

save_path = os.path.join(OUT_DIR, "23125h_progression_10min.png")
