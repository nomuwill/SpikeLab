"""
2312i KOLF2.1J MO — Control progression — first 5 min per recording.
UUID: 2026-04-18-e-KOLF21J_MO_control_sch_halo_dopamine_04272026
Output: ~/Desktop/Greg/Organized Recording Raster Plots/2312i_control_progression.png
"""
...
fig.suptitle(
    "MEA 2312i  —  KOLF2.1J MO  —  Control Progression  —  First 5 min  —  100 ms burst detection",
    fontsize=13, fontweight="bold", y=1.002,
)

save_path = os.path.join(OUT_DIR, "2312i_control_progression.png")
