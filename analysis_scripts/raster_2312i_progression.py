"""
2312i KOLF2.1J MO progression raster plots — first 5 min per recording.
UUID: 2026-04-18-e-KOLF21J_MO_control_sch_halo_dopamine_04272026
Output: ~/Desktop/Greg/Organized Recording Raster Plots/2312i_progression.png
"""
...
# (label, stem, date)
RECORDINGS = [
    ("D32 — Control",                   "2312i_KOLF21J_MO_D32_control_04152026",                       "04/15/2026"),
    ("D33 — Control (Connected)",       "2312i_KOLF21J_MO_D33_control_connectedconfig_04162026",       "04/16/2026"),
    ("D33 — Control (New)",             "2312i_KOLF21J_MO_D33_control_newconfig_04162026",             "04/16/2026"),
    ("D34 — Control (Connected)",       "2312i_KOLF21J_MO_D34_control_connectedconfig_04172026",       "04/17/2026"),
    ("D34 — Control (New)",             "2312i_KOLF21J_MO_D34_control_newconfig_04172026",             "04/17/2026"),
    ("D35 — Control (Connected)",       "2312i_KOLF21J_MO_D35_control_connectedconfig_04182026",       "04/18/2026"),
    ("D35 — Control (New)",             "2312i_KOLF21J_MO_D35_control_newconfig_04182026",             "04/18/2026"),
    ("D36 — Control",                   "2312i_KOLF21J_MO_D36_control_04192026",                       "04/19/2026"),
    ("D37 — Control",                   "2312i_KOLF21J_MO_D37_control_04202026",                       "04/20/2026"),
    ("D38 — Control",                   "2312i_KOLF21J_MO_D38_control_04212026",                       "04/21/2026"),
    ("D39 — Control",                   "2312i_KOLF21J_MO_D39_control_04222026",                       "04/22/2026"),
    ("D40 — SCH23390 + Halo",           "2312i_KOLF21J_MO_D40_24hr_control_newconfig_04232026",        "04/23/2026"),
    ("D40 — SCH23390 + Halo (acute)",   "2312i_KOLF21J_MO_D40_sch_halo_04232026",                      "04/23/2026"),
    ("D40 — Control 24hr post (Con.)",  "2312i_KOLF21J_MO_D40_control_24hr_connectedconfig_04232026",  "04/23/2026"),
    ("D40 — Control 24hr post (New)",   "2312i_KOLF21J_MO_D40_control_24hr_newconfig_04232026",        "04/23/2026"),
    ("D41 — SCH+Halo 24hr post (Con.)", "2312i_KOLF21J_MO_D41_sch_halo_24hr_connectedconfig_04242026", "04/24/2026"),
    ("D41 — SCH+Halo 24hr post (New)",  "2312i_KOLF21J_MO_D41_sch_halo_24hr_newconfig_04242026",      "04/24/2026"),
]
...
fig.suptitle(
    "MEA 2312i  —  KOLF2.1J MO  —  First 5 min  —  100 ms burst detection",
    fontsize=13, fontweight="bold", y=1.002,
)

save_path = os.path.join(OUT_DIR, "2312i_progression.png")
