"""
23137f H9SynGFP MO progression — D33-D41 + haloperidol — first 5 min.
Sources:
  D33-D38 Control : 2025-12-20-e-H9SynGFP_Midbrain_control_baseline_haloperidol_rotenone
  D36 Halo 30min  : 2025-12-18-e-MO_H9SynGFP_D36_control_baseline_haloperidol  [mislabeled — actually D40 halo]
  D39-D41         : 2026-01-02-e-Midbrain_Control_Data
Output: ~/Desktop/Greg/Organized Recording Raster Plots/23137f_progression.png
"""
...
UUID_MAIN  = "2025-12-20-e-H9SynGFP_Midbrain_control_baseline_haloperidol_rotenone"
UUID_HALO  = "2025-12-18-e-MO_H9SynGFP_D36_control_baseline_haloperidol"
UUID_LATE  = "2026-01-02-e-Midbrain_Control_Data"
...
# (label, stem, uuid)
RECORDINGS = [
    ("D33 — Control (12/15/2025)",
     "23137f_MO_H9SynGFP_D33_Control_12152025",  UUID_MAIN),
    ("D34 — Control (12/16/2025)",
     "23137f_MO_H9SynGFP_D34_Control_12162025",  UUID_MAIN),
    ("D35 — Control (12/17/2025)",
     "23137f_MO_H9SynGFP_D35_Control_12172025",  UUID_MAIN),
    ("D36 — Control (12/18/2025)",
     "23137f_MO_H9SynGFP_D36_Control_12182025",  UUID_MAIN),
    ("D37 — Control (12/19/2025)",
     "23137f_MO_H9SynGFP_D37_Control_12192025",  UUID_MAIN),
    ("D38 — Control (12/20/2025)",
     "23137f_MO_H9SynGFP_D38_Control_12202025",  UUID_MAIN),
    ("D39 — Control (12/21/2025)",
     "23137f_MO_H9SynGFP_D39_Control_122212025", UUID_LATE),
    ("D40 — Control (12/22/2025)",
     "23137f_MO_H9SynGFP_D40_Control_12222025",  UUID_LATE),
]
...
fig.suptitle(
    "MEA 23137f  —  H9SynGFP MO  —  Control Progression D33–D40  —  First 5 min  —  100 ms burst detection",
    fontsize=12, fontweight="bold", y=1.005,
)

save_path = os.path.join(OUT_DIR, "23137f_control_progression.png")
