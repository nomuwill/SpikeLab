"""
23178c KOLF2.2J SmitsMidbrain progression — first 5 min per recording.
Output: ~/Desktop/Greg/Organized Recording Raster Plots/23178c_progression.png
"""
...
fig.suptitle(
    "MEA 23178c  —  KOLF2.2J SmitsMidbrain  —  Control Progression  —  First 5 min  —  100 ms burst detection",
    fontsize=13, fontweight="bold", y=1.002,
)

save_path = os.path.join(OUT_DIR, "23178c_progression.png")
