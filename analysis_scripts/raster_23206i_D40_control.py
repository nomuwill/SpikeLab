"""
23206i KOLF2.1J MO — D40 Control 24hr post variants — first 5 min.
UUID: 2026-04-18-e-KOLF21J_MO_control_sch_halo_dopamine_04272026
Output: ~/Desktop/Greg/Organized Recording Raster Plots/23206i_D40_control_24hr.png
"""
...
RECORDINGS = [
    ...
    ("D40 — Control 24hr post (New alt)", "23206i_KOLF21J_MO_D40_24hr_control_newconfig_04232026",       "04/23/2026"),
]
...
fig.suptitle(
    "MEA 23206i  —  KOLF2.1J MO  —  D40 Control 24hr post variants  —  First 5 min",
    fontsize=13, fontweight="bold", y=1.02,
)

save_path = os.path.join(OUT_DIR, "23206i_D40_control_24hr.png")
