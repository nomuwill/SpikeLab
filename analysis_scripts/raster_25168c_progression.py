"""
25168c KOLF2.2J SmitsMidbrain progression — first 5 min per recording.
Output: ~/Desktop/Greg/Organized Recording Raster Plots/25168c_progression.png
"""
...
RECORDINGS = [
    ("D91 — Baseline (07/01/2025)",
     "25168c_D91_KOLFMO_712025_BASELINE",
     "2025-07-01-e-KOLF2.2J_SmitsMidbrain_Baseline_6OHDA_T1"),
    ("D91 — 6-OHDA T1 3hr (07/01/2025)",
     "25168c_D91_KOLFMO_712025_6OHDA_T1_3hrs",
     "2025-07-01-e-KOLF2.2J_SmitsMidbrain_Baseline_6OHDA_T1"),
    ("D91 — Control T1 3hr (07/01/2025)",
     "25168c_D91_KOLFMO_712025_CONTROL_T1_3hrs",
     "2025-07-01-e-KOLF2.2J_SmitsMidbrain_Baseline_6OHDA_T1"),
    ("D92 — Control T1 24hr (Connected) (07/02/2025)",
     "25168c_D92_KOLFMO_722025_CONTROL_T1_24hr_connected",
     "2025-07-02-e-KOLF2.2J_SmitsMidbrain_6OHDA_T1_24hr"),
    ("D92 — Control T1 24hr (New) (07/02/2025)",
     "25168c_D92_KOLFMO_722025_CONTROL_T1_24hr_newconfig",
     "2025-07-02-e-KOLF2.2J_SmitsMidbrain_6OHDA_T1_24hr"),
    ("D92 — Control T2 (07/02/2025)",
     "25168c_D92_KOLFMO_722025_CONTROL_T2",
     "2025-07-02-e-KOLF2.2J_SmitsMidbrain_6OHDA_T2"),
    ("D93 — Control T2 24hr (07/03/2025)",
     "25168c_D93_KOLFMO_732025_CONTROL_T2_24hr",
     "2025-07-03-e-KOLF2.2J_SmitsMidbrain_6OHDA_T2_24hrs"),
    ("D98 — Control T2 D6 (07/08/2025)",
     "25168c_D98_KOLFMO_782025_CONTROL_T2_D6",
     "2025-07-08-e-KOLF2.2J_D98_SmitsMidbrain_6OHDA_T2_D6"),
    ("D101 — Control T2 D10 (07/12/2025)",
     "25168c_D101_KOLFMO_7122025_CONTROL_T2_D10",
     "2025-07-12-e-KOLF2.2J_D101_SmitsMidbrain_6OHDA_T2_D10"),
]
...
fig.suptitle(
    "MEA 25168c  —  KOLF2.2J SmitsMidbrain  —  Progression  —  First 5 min  —  100 ms burst detection",
    fontsize=13, fontweight="bold", y=1.002,
)

save_path = os.path.join(OUT_DIR, "25168c_progression.png")
