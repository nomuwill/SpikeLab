"""
H9SynGFP MO dopamine progression rasters — first 5 min per recording.
...
# Each MEA: list of (label, stem, source)
# source: "pkl" | "phy" | "none"
MEAS = {
    "24478G": [
        ...
        ("D43 — Dopamine (02/24/2026) [NOT SORTED]", "24478G_MO_H9SynGFP_D43_Dopamine_02242026",   "none"),
    ],
    "21965G": [
    ...
    "24658h": [
        ("D34 — Baseline (02/24/2026) [NOT SORTED]",  "24658h_MO_H9SynGFP_D34_02242026",           "none"),
        ("D34 — Dopamine (02/24/2026) [NOT SORTED]",  "24658h_MO_H9SynGFP_D34_Dopamine_02242026",  "none"),
    ],
}
...
def make_figure(mea_id, recordings):
    ...
    fig.suptitle(
        f"MEA {mea_id}  —  H9SynGFP MO  —  Dopamine Progression  —  First 5 min  —  100 ms burst detection",
        fontsize=13, fontweight="bold", y=1.002,
    )

    save_path = os.path.join(OUT_DIR, f"{mea_id}_dopamine_progression.png")
